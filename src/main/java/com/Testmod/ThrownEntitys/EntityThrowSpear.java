...
public class EntityThrowSpear extends Entity implements IProjectile
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    private ItemSpear spear;
    public EntityThrowSpear(World worldIn)
    {
        super(worldIn);
    ...
    public EntityThrowSpear(World worldIn, double x, double y, double z,ItemSpear spear)
    {	
    ...
    public EntityThrowSpear(World worldIn, EntityLivingBase shooter, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_,ItemSpear spear)
    {
        super(worldIn);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityThrowSpear(World worldIn, EntityLivingBase shooter, float p_i1756_3_,ItemSpear spear)
    {
        super(worldIn);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = shooter;
    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            for (i = 0; i < list.size(); ++i)
            {
                ...
                System.out.println(shootingEntity);
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (this.canBePickedUp == 1 && !entityIn.inventory.addItemStackToInventory(new ItemStack(spear, 1)))
            {
                flag = false;
            }
